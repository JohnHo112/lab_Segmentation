...
def main():
    ...
    start = time.time()
    R, regions = OverSegmentation.process_over_segmentation(R, regions, ycbcr, 37, 1)
    end = time.time()
    ...
    # start = time.time()
    # R, regions = OverSegmentation.process_over_segmentation_adv(R, regions, ycbcr, 37, 1)
    # end = time.time()
